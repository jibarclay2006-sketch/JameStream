        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <LegalCard
            ...
            description={
              <>
                <Paragraph>
                  JameStream functions as a search engine and content aggregator
                ...
                <Link to="/about">Learn more about how JameStream works</Link>
              </>
            }
          />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                JameStream is entirely self hostable, and can be run on any
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                JameStream is licensed under the MIT license.
                <br />
                <br />
