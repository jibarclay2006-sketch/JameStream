...
export default defineConfig(({ mode }) => {
  ...
  const domain = env.VITE_APP_DOMAIN || "http://localhost:5173";
  return {
    ...
    plugins: [
      ...
      handlebars({
        vars: {
          ...
          routeDomain: domain + (env.VITE_NORMAL_ROUTER !== "true" ? "/#" : ""),
          domain,
          env,
        },
      }),
      ...
      VitePWA({
        ...
        manifest: {
          name: "JameStream",
          short_name: "JameStream",
          description:
            "A self-hosted media discovery and playback interface with no advertising.",
          theme_color: "#000000",
